...
_register_aggregated_stats(LogSource *self)
{
  ...
  stats_register_aggregator_hist(level, self->metrics.processing_latency_key, round_to_log2(1), 14,
...
static void
_deallocate_counter_keys(LogSource *self)
{
...
{
  /* don't initialize keys multiple times */
